...
CDNF="https://raw.githubusercontent.com/rizz-code/vpn/main"
###
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Rizz-Code/allow/main/ip > /root/tmp
...
# https://raw.githubusercontent.com/Rizz-Code/allow/main/ip 
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Rizz-Code/allow/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo ""
wget -q https://raw.githubusercontent.com/rizz-code/vpn/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
echo -e "════════════════════════════════════════" | lolcat
    ...
    DOMAIN=kimocihh.me
    # echo $sub > /root/cfku
    SUB_DOMAIN=${sub}.kimocihh.me
    CF_ID=deomain54@gmail.com
    CF_KEY=215ce4c3a698a641da9bb6077519faec07657
    echo "kimocihh.me" > /root/domain
...
sleep 2
clear
wget -q https://raw.githubusercontent.com/rizz-code/vpn/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget -q https://raw.githubusercontent.com/rizz-code/vpn/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "$green[INFO]$NC Install SET-BR!"
wget -q https://raw.githubusercontent.com/rizz-code/vpn/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "$green[INFO]$NC Install WEBSOCKET!"
wget -q https://raw.githubusercontent.com/rizz-code/vpn/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget -q https://raw.githubusercontent.com/rizz-code/vpn/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget -q https://raw.githubusercontent.com/rizz-code/vpn/main/update/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
...
function password_default() {
    ...
    Exp=$(curl -sS https://raw.githubusercontent.com/Rizz-Code/allow/main/ip | grep $IP | awk '{print $3}')
    Name=$(curl -sS https://raw.githubusercontent.com/Rizz-Code/allow/main/ip | grep $IP | awk '{print $2}')
    datediff "$Exp" "$DATE"
    mkdir -p /home/script/
    ...
    TEXT="Installasi VPN Script Stable V2.5
